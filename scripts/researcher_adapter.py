...
class ResearcherAdapter:
    ...
    def run_daily_research(self) -> Any:
        ...
        try:
            ...
            # Recreate settings so Pydantic reads the process env generated by
            # sync_config(); the global singleton may already hold default
            # sk-dummy values from an earlier import.
